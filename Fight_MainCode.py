...
from Mini_monsters import Mini_monsters, player_is_attacking 
...
def game_run(levels):
    ...
    if huidige_level == 2:
        ...
        if Theseus.gewapend and (keys[pygame.K_LEFT] or keys[pygame.K_RIGHT]):
            player_is_attacking = True
            for vijand in vijanden:
                vijand.attack(Theseus, player_is_attacking)
